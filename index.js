    ...
    for (const v of event["Message"].split("&")) {
      ...
      switch (TENCENTSCF_SOURCE_TYPE) {
        ...
        case 'git':
          ...
          request(`https://raw.githubusercontent.com/esiwsh/jd_scripts/master/${v}.js`, function (error, response, body) {
            eval(response.body)
          })
          break;
        case 'custom':
        ...
        default:
          ...
          request(`https://gitee.com/esiwsh/jd_scripts/raw/master/${v}.js`, function (error, response, body) {
            eval(response.body)
          })
          break;
      }
